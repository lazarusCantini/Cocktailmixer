...
//  LCD DB4-DB7 <-->  PORTD Bit PA0-PA3
#define LCD_PORT      PORTE
#define LCD_DDR       PORTE_DIR
#define LCD_DB        PIN2

//  LCD RS      <-->  PORTD Bit PA4     (RS: 1=Data, 0=Command)
#define LCD_RS        PIN0

//  LCD EN      <-->  PORTD Bit PA5     (EN: 1-Impuls für Daten)
#define LCD_EN        PIN1
